  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Shape Modes sú deštruktívne, Pathfinders nedeštruktívne',
          'Shape Modes sú nedeštruktívne, Pathfinders deštruktívne',
          'Nie je medzi nimi rozdiel',
          'Shape Modes fungujú len vo Photoshope'
        ],
        correctAnswer: 1
      },
      {
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Zvýrazňuje farby',
          'Odstraňuje farebné fringes z pozadia',
          'Pridáva saturáciu',
          'Invertuje farby'
        ],
        correctAnswer: 1
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Layer Mask je deštruktívna',
          'Layer Mask je pixel-based, Vector Mask je path-based',
          'Vector Mask nemožno editovať',
          'Nie je medzi nimi rozdiel'
        ],
        correctAnswer: 1
      },
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Horizontálny rozostup medzi znakmi',
          'Vertikálny rozostup medzi riadkami',
          'Veľkosť písma',
          'Farbu textu'
        ],
        correctAnswer: 1
    ...
    exercises: [
      {
        ...
        options: [
          ...
          'Window > Neural Filters',
          'Layer > Neural Filters'
        ],
        correctAnswer: 1
      },
      {
      ...
      },
      {
        ...
        options: [
          'Zmenu farieb',
          'Pridanie farieb do čiernobielych fotografií',
          'Odstránenie farieb',
          'Úpravu kontrastu'
        ],
        correctAnswer: 1
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Pridáva šum do výsledku',
          'Ignoruje malé pixelové oblasti',
          'Zvyšuje kontrast',
          'Mení farebný priestor'
        ],
        correctAnswer: 1
      },
      {
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Pucker zväčšuje, Bloat zmenšuje',
          'Pucker zmenšuje, Bloat zväčšuje',
          'Nie je medzi nimi rozdiel',
          'Pucker je rýchlejší'
        ],
        correctAnswer: 1
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Clone Stamp je rýchlejší',
          'Healing Brush blenduje textúru s okolím',
          'Clone Stamp má viac možností',
          'Žiadny rozdiel'
        ],
        correctAnswer: 1
      },
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        options: [
          'Sharpening',
          'Selektívne úpravy jednotlivých farieb',
          'Noise reduction',
          'Lens corrections'
        ],
        correctAnswer: 1
